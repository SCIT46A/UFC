...
const tpFilterBtn = document.querySelector(
    ".club-detail-filter-teenplay button"
);
...
const noticeFilterBtn = document.querySelector(
    ".club-detail-filter-notice .club-detail-filter-button"
);
...
const noticeContentWraps = document.querySelectorAll(
    ".club-notice-content-wrap"
);
...
const afterUploadModal = document.querySelector(
    ".upload-modal-content-container.after"
);
const beforeUploadModal = document.querySelector(
    ".upload-modal-content-container.before"
);
...
const uploadedThumbnailInfo = document.querySelector(
    ".pr-write-uploaded-thumbnail-container"
);
...
const finalSaveButton = document.querySelector(
    ".upload-modal-confirm-button-wrap"
);
...
finalSaveButton.addEventListener("click", () => {
    Swal.fire({
        ...
        if (result.value) {
            ...
            Swal.fire(
                "업로드 진행중",
                "업로드를 진행합니다. <br> 업로드는 최대 5분 안에 완료됩니다!",
                "success"
            );
        } else if (result.dismiss == "cancel") {
            return;
...
// 실제 삭제는 서버에서 구현합니다.
const teenplayDeleteIconBlacks = document.querySelectorAll(
    ".club-teenplay-delete"
);
const teenplayDeleteIconHovers = document.querySelectorAll(
    ".club-teenplay-delete-hover"
);
const teenplayDeleteWraps = document.querySelectorAll(
    ".club-teenplay-delete-wrap"
);
const teenplayContentsWrap = document.querySelector(
    ".club-teenplay-contents-box"
);
